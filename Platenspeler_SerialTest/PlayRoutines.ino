...
void startPlay() {
  ...
  switch (subroutineSteps) {
    ...
    case 2:
      ...
      //move pos to base
      //toneArmPosEnum = BASE;
      if (MoveArmPosServo(BACKTOBASE, 2)) {
    ...
    case 3:
      ...
      if (millis() - subroutineMillis >= 500) {
        subroutineSteps = 4;
      }
      break;
